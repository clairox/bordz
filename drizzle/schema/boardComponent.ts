...
export const BoardComponentAttrs = pgTableWithAutoFields(
    ...
    {
        boardComponentId: shortUuid('board_component_id')
...
export const BoardComponentAttrsRelations = relations(
    BoardComponentAttrs,
    ({ one }) => ({
        boardComponent: one(BoardComponents, {
            fields: [BoardComponentAttrs.boardComponentId],
